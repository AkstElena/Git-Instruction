...
* **cd "folder name"** - позволяет перейти на необходимую папку на уровень ниже, для дальнейшей работы с ней

* **cd ..** - позволяет перейти в папку на уровень выше
...
* **git branch -M main** - переименование ветки Master в main (в удаленном репозитории по умолчанию главная ветка main, в локальном Master)
...
1. **git remote add origin URL** - указываем адрес (при этой команде удаленный репозиторий будет связан с локальным)
...
Данная команда появится при нажатии на кнопку Contribute
![Скрин](/Picture2.png)

Описание репозитория можно ввести в поле Description
![Скрин](/Picture3.png)
