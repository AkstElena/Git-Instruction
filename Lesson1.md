...
* **git branch** - показывает имеющиеся ветки с выделением той, на которой находится сейчас. При внесение изменений "-" и красным показано удаление, "+" и зеленое добавление
